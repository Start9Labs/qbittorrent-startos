...
This returns tags like `release-5.2.2`. The Docker image tag is the same without the `release-` prefix, e.g. `5.2.2`.
...
2. Edit `startos/versions/current.ts` — update the version string (e.g. `'5.2.2:0'`).
